...
# Evaluation
# Prediction on training data
rf_training_data_prediction = regressor.predict(X_train)
rf_r2_train = metrics.r2_score(Y_train, rf_training_data_prediction)
rf_mse_train = metrics.mean_squared_error(Y_train, rf_training_data_prediction)
rf_mae_train = metrics.mean_absolute_error(Y_train, rf_training_data_prediction)

print('Random_Forest R Squared Value (Train) = ', rf_r2_train)
print('Random_Forest Mean Squared Error (Train) = ', rf_mse_train)
print('Random_Forest Mean Absolute Error (Train) = ', rf_mae_train)

# Predict for testing data
rf_test_data_prediction = regressor.predict(X_test)
rf_r2_test = metrics.r2_score(Y_test, rf_test_data_prediction)
rf_mse_test = metrics.mean_squared_error(Y_test, rf_test_data_prediction)
rf_mae_test = metrics.mean_absolute_error(Y_test, rf_test_data_prediction)

print('Random_Forest R Squared Value (Test) = ', rf_r2_test)
print('Random_Forest Mean Squared Error (Test) = ', rf_mse_test)
print('Random_Forest Mean Absolute Error (Test) = ', rf_mae_test)
...
# Evaluation
# Prediction on training data
lr_training_data_prediction = lasso_regressor.predict(X_train)
lr_mse_train = metrics.mean_squared_error(Y_train, lr_training_data_prediction)
lr_mae_train = metrics.mean_absolute_error(Y_train, lr_training_data_prediction)

print('Lasso_Regression Mean Squared Error (Train) = ', lr_mse_train)
print('Lasso_Regression Mean Absolute Error (Train) = ', lr_mae_train)

# Predict for testing data
lr_test_data_prediction = lasso_regressor.predict(X_test)
lr_mse_test = metrics.mean_squared_error(Y_test, lr_test_data_prediction)
lr_mae_test = metrics.mean_absolute_error(Y_test, lr_test_data_prediction)

print('Lasso_Regression Mean Squared Error (Test) = ', lr_mse_test)
print('Lasso_Regression Mean Absolute Error (Test) = ', lr_mae_test)